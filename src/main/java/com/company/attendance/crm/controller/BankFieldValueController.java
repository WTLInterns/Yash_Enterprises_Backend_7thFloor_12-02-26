...
public class BankFieldValueController {
    ...
    @GetMapping
    public List<BankFieldValue> list(@PathVariable Long bankId){ return service.list(bankId); }

    @PostMapping
    public ResponseEntity<BankFieldValue> upsert(@PathVariable Long bankId, @RequestBody Map<String, String> body){
